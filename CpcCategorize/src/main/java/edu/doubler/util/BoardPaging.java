...
public class BoardPaging {
	static final int PRINT_CONTENT_COUNT = 10;	// 한 페이지에 보여줄 글의 수
	static final int PRINT_PAGE_COUNT = 5;		// 한 화면당 페이지의 수
	...
	// 생성자
	public BoardPaging(){
		this.setCurrentPage(1);		// 현재 페이지 1
		this.setCurrentBlock(1);	// 현재 페이지 블록 1
		this.setFirstPageNum(1);	// 기본 설정
		this.setFirstBlock(1);		// 기본 설정
	}
	
	// 파라미터 생성자
	public BoardPaging(String pageNum){
		int num = Integer.parseInt(pageNum);
		int block = num % PRINT_PAGE_COUNT != 0? num/PRINT_PAGE_COUNT + 1 : num/PRINT_PAGE_COUNT;
...
//		System.out.println("전체 데이터 개수 : " + getContentCount());
//		System.out.println("현재 페이지 위치 : " + getCurrentPage());
//		System.out.println("현재 페이지 블록 : " + getCurrentBlock());
//		System.out.println("필요 페이지 블록 : " + getNeedBlocks());
//		System.out.println("--------------------\n");
